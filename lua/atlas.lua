...
local function set_highlights()
    ...
    local legacy_highlights = {
        ...
        ["@text.title.1.marker.markdown"] = {
            link = "markdownH1Delimiter",
        },
        ["@text.title.2.markdown"] = { link = "markdownH2" },
        ["@text.title.2.marker.markdown"] = {
            link = "markdownH2Delimiter",
        },
        ["@text.title.3.markdown"] = { link = "markdownH3" },
        ["@text.title.3.marker.markdown"] = {
            link = "markdownH3Delimiter",
        },
        ...
        ["@text.title.5.marker.markdown"] = {
            link = "markdownH5Delimiter",
        },
        ["@text.title.6.markdown"] = { link = "markdownH6" },
        ["@text.title.6.marker.markdown"] = {
            link = "markdownH6Delimiter",
        },
    ...
    local transparency_highlights = {
        ...
        NormalNC = {
            fg = palette.text,
            bg = config.options.dim_inactive_windows and palette._nc or "NONE",
        },
        ...
        SignColumn = { fg = palette.text, bg = "NONE" },
        StatusLine = { fg = palette.subtle, bg = "NONE" },
        StatusLineNC = { fg = palette.subtle, bg = "NONE" },
